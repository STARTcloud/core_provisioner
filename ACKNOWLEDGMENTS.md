...
Core Provisioner is built on excellent open-source projects. We're grateful to the developers and communities behind them.

## Core tooling

**Vagrant** — the machine lifecycle this driver plugs into
...
- **vagrant_utm** — UTM provider for Apple Silicon macOS hosts
