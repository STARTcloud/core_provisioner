...
- How does this limitation affect your use of Core Provisioner?
...
- What would the `Hosts.yml` configuration look like (if applicable)?
...
- [ ] Critical (essential for provisioning)
...
- [ ] Providers (VirtualBox / UTM / zones)
- [ ] Networking
- [ ] Disks
...
- [ ] `Hosts.yml` schema change likely
- [ ] Affects downstream provisioners
- [ ] Unknown
